...
# Decorators personalizados para níveis de acesso
...
@login_required
@acesso_restrito(['ADMIN', 'VISUALIZADOR'])
...
@login_required
@acesso_restrito(['ADMIN', 'OPERADOR'])
...
@login_required
@acesso_restrito(['ADMIN', 'OPERADOR', 'VISUALIZADOR'])
